...
import com.backend.proyectoclinicaodontologica.dto.output.DomicilioDtoOut;
...
public class TestDataUtil {
    ...
    public static PacienteDtoOut createPacienteDtoOutConId(Long id) {
        return new PacienteDtoOut(id, "Cass", "Layza", 12345678, LocalDate.of(2024, 6, 27), new DomicilioDtoOut(1L,"Los Alamos", 471, "Miraflores", "Lima"));
    }
